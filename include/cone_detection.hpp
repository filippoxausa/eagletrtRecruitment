...
#define LIMIT_DIST_NORM 80.0 // Distanza massima in cui sovrapporre i coni
#define LIMIT_DIST_X 3.0 // Distanza massima (orizzontale) in cui sovrapporre i coni


std::vector<cv::Point> getConeCenters(const cv::Mat& mask, double areaMin = 25.0, double areaMax = 1200.0);
